...
public abstract class Entity extends Sprite implements Definable {
	...
	/**
	 * Diese Methode gibt den jeweiligen Entity aus den zwei Fixtures zurück. Man muss nur die EntityType Klasse angeben. 
	 * Beispiel:
	 * 
	 * Wenn ich 2 Fixtures habe (Siehe {@link WorldContactListener#beginContact(com.badlogic.gdx.physics.box2d.Contact)})
	 * und die dann übergebe. Muss ich als drittes Argument die Klasse angeben. Wenn ich ein Player will gebe ich Player.class an,
	 ...
	 * @param entityType - Der EntityType der zurückgegeben werden soll.
	 * @return
	 */
